...
from .views import (StudyAuthorizationView, StudyConnectionReturnView,
                    StudyGrantView, StudyGrantCompletionView)
...
urlpatterns = [
    ...
    # TODO: 'connect' in the URL could be 'grant'
    url(r'^connect/(?P<slug>[a-z0-9-]+)/$',
        StudyGrantView.as_view(),
        name='connect'),

    url(r'^complete/(?P<slug>[a-z0-9-]+)/$',
        StudyGrantCompletionView.as_view(),
        name='complete'),
